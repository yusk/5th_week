...
#define MMA8652_sensitivity    1024  // [LSB/g]  @2g mode

/* Interval time for toggle LED which is used for flashing LED (0 - 262140ms) */
#ifndef mMMA8652Interval_c
#define mMMA8652Interval_c  700
#endif

#define MMA8652_SlaveAddressIIC (0x1D<<1)
...
void  (*pfMMA8652_CallBack)(void);


/***********************************************************************************************
**  MPL3115A2 Sensor Internal Registers
********************************************************************************************** */
//define MMA865x_IIC_ADDRESS       0x38

/* Data struct received from ACC */
typedef struct dataFrom_MMA8652_tag {
  int16_t xOutReg;
  int16_t yOutReg;
  int16_t zOutReg;
