...
enum {
  ...
  mZtcOtapSupportSetInternalFlashReq_c  = 0x28,
  ...
  mZtcMsgSelectWakeUpPINReq_c       = 0x40, /* ZTC-SelectWakeUpPIN.Request          */
  mZtcMsgWakeUpIndication_c         = 0x41, /* ZTC-WakeUp.Indication                */
