...
************************************************************************************/
  ...
  // Array-functionality specific base, and head pointers
static uint8_t *pmaFlibArrayBase, *pmaFlibArray;
...
{
  pmaFlibArrayBase = pmaFlibArray = pArray;
}
...
{
  return (uint8_t)((pmaFlibArray - pmaFlibArrayBase) + bias);
}
...
{
   pmaFlibArray = pmaFlibArrayBase + offset;
}
